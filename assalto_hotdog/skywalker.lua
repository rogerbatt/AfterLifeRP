...
-----------------------------------------------------------------------------------------------------------------------------------------
roB = {}
Tunnel.bindInterface("assalto_hotdog",roB)
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIAVEIS
-----------------------------------------------------------------------------------------------------------------------------------------
...
-- WEBHOOK
-----------------------------------------------------------------------------------------------------------------------------------------
local webhookhotdog = "https://discordapp.com/api/webhooks/741439322523172926/DHKBSPpXgdup215HOXNhfbN1s8KThEAXYkobfjcYNH7vIOYlbtxrwnxl0MM1gRBMn-R5"
-----------------------------------------------------------------------------------------------------------------------------------------
-- TEMPO
-----------------------------------------------------------------------------------------------------------------------------------------
local timers = {}
	...
	if user_id then
		...
		if #policia >= 1 then
			if timers[id] == 0 or not timers[id] then
				...
				TriggerClientEvent('iniciohotdog',source,head,x,y,z)
					...
					for l,w in pairs(policia) do
						...
						if player then
							async(function()
								...
								TriggerClientEvent('chatMessage',player,"190",{64,64,255},"O roubo começou na ^1Barraquinha de HOTDOG^0, dirija-se até o local e intercepte o assaltante.")
				...
				SetTimeout(30000,function()
					local dinheiroRoubado = math.random(500,3000)
