...
RegisterNUICallback("ButtonClick",function(data,cb)
	if data == "produzir-m-vp9" then
		TriggerServerEvent("produzir-municao","m-vp9")
...
AddEventHandler("fechar-nui-municoes", function()
	...
	local bowz,cdz = GetGroundZFor_3dCoord(1403.56, 1136.56, 109.75)
	local distance = GetDistanceBetweenCoords(1403.56, 1136.56, cdz, x, y, z, true)
...
AddEventHandler("municao:posicao1", function()
	local ped = PlayerPedId()
	SetEntityHeading(ped, 173.27)
	SetEntityCoords(ped, 1403.56, 1136.56, 109.75-0.90,false,false,false,false)
end)
