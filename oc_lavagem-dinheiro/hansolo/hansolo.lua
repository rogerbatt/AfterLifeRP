...
Citizen.CreateThread(function()
    while true do
        ...
        for k,v in pairs(maquinas) do
            ...
            if GetDistanceBetweenCoords(GetEntityCoords(PlayerPedId()), maquinas.x, maquinas.y, maquinas.z, true) < 1.2 then
...
AddEventHandler("lavagem-dinheiro:posicao", function()
	local ped = PlayerPedId()
	SetEntityHeading(ped, 52.32)
	SetEntityCoords(ped, 989.38,-135.96,74.07-1,false,false,false,false)
end)
